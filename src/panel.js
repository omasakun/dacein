...
export const Panel = ({ children, direction = DIRECTION.HORIZONTAL, defaultDivide = 0.5 }) => {
  ...
  const wrapperClassName = direction === DIRECTION.HORIZONTAL ? 'flex' : 'flex flex-column'
