  ...
  <Overlay width={600} height={600} onClose={onClose}>
    <div className='overflow-scroll h-100 pa3'>
      <div className='measure-wide lh-copy f7 light-gray'>
        <p>
          <span className='gray'>dacein</span> is an experimental IDE and library for creative
          coding made by <A href='https://szymonkaliski.com'>Szymon Kaliski</A>.
        </p>

        <p>
          In addition to declarative canvas-based graphics library it provides color and number
          pickers in editor for <span className='i'>live coding</span>,{' '}
          <span className='i'>time travel</span> through the sketch updates and{' '}
          <span className='i'>direct manipulation</span> from canvas back into code.
        </p>

        <p>
          Both <span className='i'>time travel</span> and{' '}
          <span className='i'>direct manipulation</span> are only available when the sketch is
          paused.
        </p>
        ...
        <ol className='list pl3'>
          ...
          <li style={{ listStyle: 'disc' }}>
            to manipulte the code, drag an <span className='gray'>ellipse</span> or{' '}
            <span className='gray'>rect</span>
          </li>
        </ol>
        ...
        <p>
          The <span className='gray'>sketch</span> library is a global function requiring an object
          with at least a <span className='gray'>draw</span> property:
        </p>
      </div>
